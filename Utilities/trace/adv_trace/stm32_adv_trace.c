...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_Init(void)
{
    ...
    (void) UTIL_ADV_TRACE_MEMSET8(&ADV_TRACE_Ctx, 0x0,
            sizeof(ADV_TRACE_Context));
    (void) UTIL_ADV_TRACE_MEMSET8(&ADV_TRACE_Buffer, 0x0,
            sizeof(ADV_TRACE_Buffer));
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_StartRxProcess(
        void (*UserCallback)(uint8_t *PData, uint16_t Size, uint8_t Error))
{
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_COND_FSend(uint32_t VerboseLevel,
        uint32_t Region, uint32_t TimeStampState, const char *strFormat, ...)
{
    va_list vaArgs;
#if defined(UTIL_ADV_TRACE_UNCHUNK_MODE)
  ...
  uint8_t buf[UTIL_ADV_TRACE_TMP_BUF_SIZE+UTIL_ADV_TRACE_TMP_MAX_TIMESTMAP_SIZE];
    ...
    buff_size = (uint16_t) UTIL_ADV_TRACE_VSNPRINTF((char* )sztmp,
            UTIL_ADV_TRACE_TMP_BUF_SIZE, strFormat, vaArgs);
    ...
    UTIL_ADV_TRACE_EXIT_CRITICAL_SECTION();
        ...
        /* copy the data */
        (void) UTIL_ADV_TRACE_VSNPRINTF((char* )(&ADV_TRACE_Buffer[writepos]),
                UTIL_ADV_TRACE_TMP_BUF_SIZE, strFormat, vaArgs);
        va_end(vaArgs);
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_FSend(const char *strFormat, ...)
{
    ...
    va_start(vaArgs, strFormat);
    uint16_t bufSize = (uint16_t) UTIL_ADV_TRACE_VSNPRINTF((char* )buf,
            UTIL_ADV_TRACE_TMP_BUF_SIZE, strFormat, vaArgs);
    va_end(vaArgs);
...
#if defined(UTIL_ADV_TRACE_CONDITIONNAL)
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_COND_ZCSend_Allocation(
        uint32_t VerboseLevel, uint32_t Region, uint32_t TimeStampState,
        uint16_t length, uint8_t **pData, uint16_t *FifoSize,
        uint16_t *WritePos)
{
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_ZCSend_Allocation(uint16_t Length,
        uint8_t **pData, uint16_t *FifoSize, uint16_t *WritePos)
{
    UTIL_ADV_TRACE_Status_t ret = UTIL_ADV_TRACE_OK;
    uint16_t writepos;
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_COND_Send(uint32_t VerboseLevel,
        uint32_t Region, uint32_t TimeStampState, const uint8_t *pData,
        uint16_t Length)
{
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_Send(const uint8_t *pData,
        uint16_t Length)
{
    UTIL_ADV_TRACE_Status_t ret;
    uint16_t writepos;
        ...
        if (ADV_TRACE_Ctx.TraceRdPtr != ADV_TRACE_Ctx.TraceWrPtr)
        {
            ...
            if (TRACE_UNCHUNK_DETECTED == ADV_TRACE_Ctx.unchunk_status)
            {
                ADV_TRACE_Ctx.TraceSentSize =
                        (uint16_t) (ADV_TRACE_Ctx.unchunk_enabled
                                - ADV_TRACE_Ctx.TraceRdPtr);
            ...
            if (TRACE_UNCHUNK_NONE == ADV_TRACE_Ctx.unchunk_status)
            {
                ...
                if (ADV_TRACE_Ctx.TraceWrPtr > ADV_TRACE_Ctx.TraceRdPtr)
                {
                    ADV_TRACE_Ctx.TraceSentSize = ADV_TRACE_Ctx.TraceWrPtr
                            - ADV_TRACE_Ctx.TraceRdPtr;
                }
                else /* TraceRdPtr > TraceWrPtr */
                {
                    ADV_TRACE_Ctx.TraceSentSize = UTIL_ADV_TRACE_FIFO_SIZE
                            - ADV_TRACE_Ctx.TraceRdPtr;
...
static void TRACE_TxCpltCallback(void *Ptr)
{
  ...
  if(ADV_TRACE_Ctx.OverRunStatus == TRACE_OVERRUN_TRANSFERT)
  {
    ...
    {
        ADV_TRACE_Ctx.TraceRdPtr = (ADV_TRACE_Ctx.TraceRdPtr
                + ADV_TRACE_Ctx.TraceSentSize) % UTIL_ADV_TRACE_FIFO_SIZE;
    }
#else
  ...
  if(ADV_TRACE_Ctx.OverRunStatus == TRACE_OVERRUN_INDICATION)
  {
    ...
    if ((ADV_TRACE_Ctx.TraceRdPtr != ADV_TRACE_Ctx.TraceWrPtr)
            && (1u == ADV_TRACE_Ctx.TraceLock))
    {
#ifdef UTIL_ADV_TRACE_UNCHUNK_MODE
        if (TRACE_UNCHUNK_DETECTED == ADV_TRACE_Ctx.unchunk_status)
        {
            ADV_TRACE_Ctx.TraceSentSize = ADV_TRACE_Ctx.unchunk_enabled
                    - ADV_TRACE_Ctx.TraceRdPtr;
            ADV_TRACE_Ctx.unchunk_status = TRACE_UNCHUNK_TRANSFER;
            ADV_TRACE_Ctx.unchunk_enabled = 0;
...
#endif
        ptr = &ADV_TRACE_Buffer[ADV_TRACE_Ctx.TraceRdPtr];
        UTIL_ADV_TRACE_EXIT_CRITICAL_SECTION(); UTIL_ADV_TRACE_DEBUG("\n--TRACE_Send(%d-%d)--\n", ADV_TRACE_Ctx.TraceRdPtr, ADV_TRACE_Ctx.TraceSentSize);
        UTIL_TraceDriver.Send(ptr, ADV_TRACE_Ctx.TraceSentSize);
    }
    else
    {
...
static int16_t TRACE_AllocateBufer(uint16_t Size, uint16_t *Pos)
{
    ...
    else
    {
        ...
        {
            freesize = (uint16_t) (ADV_TRACE_Ctx.TraceRdPtr
                    - ADV_TRACE_Ctx.TraceWrPtr);
        }
#else
    if (ADV_TRACE_Ctx.TraceWrPtr > ADV_TRACE_Ctx.TraceRdPtr)
    ...
    if (freesize > Size)
    {
        *Pos = ADV_TRACE_Ctx.TraceWrPtr;
        ADV_TRACE_Ctx.TraceWrPtr = (ADV_TRACE_Ctx.TraceWrPtr + Size)
